export const htmlSaAddRequest = `<!DOCTYPE html>
   <html lang="en">
      <head>
         <meta charset="UTF-8">
         <meta name="viewport" content="width=device-width, initial-scale=1.0">
         <title>APAC Management System - Review Required - {{applicantFirstName}} - {{requestType}} Request</title>
         <!--[if mso]>
         <style>
         ...
         <table role="presentation" cellpadding="0" cellpadding="0" border="0" width="100%">
            <tr>
               <td align="center" style="padding:20px 30px;">
                  <table role="presentation" cellpadding="0" cellpadding="0" border="0" width="600" style="background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 15px 50px rgba(201,42,42,0.15);border:1px solid rgba(201,42,42,0.1);">
                     <!-- Header Section -->
                     <tr>
                        <td class="header-bg" style="background:linear-gradient(135deg, #c92A2A 0%, #d43f3f 50%, #e25757 100%);background-color:#c92A2A;padding:40px 30px;color:#ffffff;text-align:left;position:relative;overflow:hidden;">
                           ...
                           <div style="position:relative;z-index:3;">
                              ...
                              <p style="margin:0;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-size:15px;font-weight:600;color:#f8f9fa;letter-spacing:1.2px;">
                                 Review Required - {{applicantFirstName}} - {{requestType}} Request
                              </p>
                           </div>
                        </td>
                     </tr>
                     ...
                     <tr>
                        <td class="body-bg" style="padding:45px 35px;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;color:#2a2d37;text-align:left;background:linear-gradient(180deg, #ffffff 0%, #fdfdfd 100%);background-color:#ffffff;">
                           ...
                           <p style="font-size:16px;line-height:1.6;margin:0 0 16px 0;color:#2a2d37;">
                              Hi {{superAdminFullName}},
                           </p>
                           <p style="font-size:16px;line-height:1.7;margin:0 0 30px 0;color:#4a4f5c;">
                              Your administrative review is required for a <strong style="color:#c92A2A;">{{requestType}}</strong> request submitted by <strong>{{applicantFullName}} <span style="background:#c92A2A;color:white;padding:2px 8px;border-radius:4px;font-size:12px;margin-left:8px;">{{applicantRole}}</span></strong>, who holds the position of <strong style="color:#c92A2A;">Chief Operating Officer</strong>.
                           </p>
                           <!-- Important Notice Card -->
                           <div style="margin:25px 0;padding:20px;background:linear-gradient(135deg, #fff3cd 0%, #ffeaa7 100%);border-radius:12px;border-left:4px solid #ffc107;">
                              ...
                              <p style="font-size:14px;line-height:1.5;margin:0;color:#856404;">
                                 This request requires system administrator review as it originates from the COO level. Please ensure proper documentation and compliance with organizational policies.
                              </p>
                           </div>
                           <div style="margin:30px 0;padding:25px;background:linear-gradient(135deg, #f8f9fa 0%, #f0f2f5 100%);background-color:#f8f9fa;border-radius:12px;border-left:4px solid #c92A2A;">
                              ...
                              <table role="presentation" width="100%" cellpadding="0" cellpadding="0">
                                 ...
                                 <td style="padding:5px 0;color:#2a2d37;">{{teamLeadFullName}}</td>
                                 </tr>
                                 <tr>
                                 ...
                                 <tr>
                                    <td width="140" style="padding:5px 0;"><strong style="color:#5a6170;">Reason:</strong></td>
                                    <td style="padding:5px 0;color:#2a2d37;">{{requestReason}}</td>
                                 </tr>
                              </table>
                           </div>
                           <!-- Action Required Section -->
                           <div style="margin:35px 0;">
                              <p style="font-size:15px;font-weight:600;color:#2a2d37;margin:0 0 15px 0;">
                                 🎯 Action Required:
                              </p>
                              <ul style="font-size:14px;line-height:1.6;color:#4a4f5c;margin:0 0 25px 0;padding-left:20px;">
                                 <li style="margin-bottom:8px;">Review the COO's leave request for compliance</li>
                                 <li style="margin-bottom:8px;">Verify organizational impact and coverage</li>
                                 <li style="margin-bottom:8px;">Add appropriate administrative remarks</li>
                                 <li>Process according to company policies</li>
                              </ul>
                              <!-- Comment Button - Left Aligned -->
                           <a href="{{remarksUrl}}"
                              target="_blank"
                           ...
                           <p style="margin-top:16px;color:#6c757d;font-size:14px;font-weight:300">
                              Your administrative oversight ensures proper governance and compliance for executive-level requests.
                           </p>
                           <!-- Footer Text -->
                           <div style="margin:35px 0 0 0;padding:25px;background:linear-gradient(135deg, #fef7f7 0%, #fafafa 100%);background-color:#fef7f7;border-radius:12px;border-left:4px solid #c92A2A;">
                              <p style="font-size:15px;line-height:1.6;margin:0;font-style:italic;color:#6a7180;">
                                 Best regards,<br>
                                 <strong style="color:#2a2d37;font-size:16px;">APAC Management System - Administrator Portal</strong>
                              </p>
                           </div>
                        </td>
                     </tr>
   ...
   `;
export const htmlHrRemarks = `<!DOCTYPE html>
   <html lang="en">
      <head>
         <meta charset="UTF-8">
         <meta name="viewport" content="width=device-width, initial-scale=1.0">
         <title>APAC Management System - Remarks Added - {{applicantFullName}} - {{requestType}} Request</title>
         <!--[if mso]>
         <style>
            .header-bg { background-color: #c92A2A !important; }
            .button-bg { background-color: #c92A2A !important; }
               ...
               <td align="center" style="padding:20px 30px;">
                  <table role="presentation" cellpadding="0" cellpadding="0" border="0" width="600" style="background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 15px 50px rgba(201,42,42,0.15);border:1px solid rgba(201,42,42,0.1);">
                     ...
                     <tr>
                        <td class="header-bg" style="background:linear-gradient(135deg, #c92A2A 0%, #d43f3f 50%, #e25757 100%);background-color:#c92A2A;padding:40px 30px;color:#ffffff;text-align:left;position:relative;overflow:hidden;">
                           ...
                           <div style="position:relative;z-index:3;">
                              ...
                              <div style="height:3px;width:60px;background:linear-gradient(90deg, rgba(255,255,255,0.8) 0%, transparent 100%);background-color:rgba(255,255,255,0.8);margin:12px 0 8px 0;border-radius:2px;"></div>
                              <p style="margin:0;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-size:15px;font-weight:600;color:#f8f9fa;letter-spacing:1.2px;">
                                 Remarks Added - {{applicantFullName}} - {{requestType}} Request
                              </p>
                           </div>
                        </td>
                     </tr>
                     ...
                     <div style="width:90px;height:90px;background:linear-gradient(135deg, rgba(201,42,42,0.08) 0%, rgba(226,87,87,0.12) 100%);background-color:rgba(201,42,42,0.08);border-radius:50%;line-height:90px;text-align:center;font-size:36px;color:#c92A2A;border:2px solid rgba(201,42,42,0.1);box-shadow:0 8px 25px rgba(201,42,42,0.15);">
                           ...
                           <p style="font-size:16px;line-height:1.7;margin:0 0 30px 0;color:#4a4f5c;">
                              <strong style="color:#c92A2A;">New update!</strong> Remarks have been added to the <strong style="color:#c92A2A;">{{requestType}}</strong> request.
                              {{commenterName}} has shared feedback that requires your attention.
                           </p>
                           ...
                           <div style="margin:30px 0;padding:25px;background:linear-gradient(135deg, #f8f9fa 0%, #f0f2f5 100%);background-color:#f8f9fa;border-radius:12px;border-left:4px solid #c92A2A;">
                              ...
                              <table role="presentation" width="100%" cellpadding="0" cellpadding="0">
                                 ...
                                 <tr>
                                    <td width="140" style="padding:5px 0;"><strong style="color:#5a6170;">Team Lead:</strong></td>
                                    <td style="padding:5px 0;color:#2a2d37;">{{commenterName}}</td>
                                 </tr>
                                 <tr>
                                    <td width="140" style="padding:5px 0;"><strong style="color:#5a6170;">Request Type:</strong></td>
                                    <td style="padding:5px 0;color:#2a2d37;">{{requestType}}</td>
                                 ...
                                 <tr>
                                    <td width="140" style="padding:5px 0;"><strong style="color:#5a6170;">Remarks:</strong></td>
                                    <td style="padding:5px 0;color:#2a2d37;font-style:italic;">"{{commenterRemarks}}"</td>
                                 </tr>
                                 <tr>
                                    <td width="140" style="padding:5px 0;"><strong style="color:#5a6170;">Added By:</strong></td>
                                    <td style="padding:5px 0;color:#2a2d37;">{{commenterName}}<span style="background:#c92A2A;color:white;padding:2px 8px;border-radius:4px;font-size:12px;margin-left:8px;">{{commenterRole}}</span></td>
                                 </tr>
                              </table>
                           </div>
                           ...
                           <p style="margin-top:16px;color:#6c757d;font-size:14px;font-weight:300">
                              Your attention to this update helps us maintain smooth workflow processes.
                           </p>
                           <!-- Footer Text -->
                           <div style="margin:35px 0 0 0;padding:25px;background:linear-gradient(135deg, #fef7f7 0%, #fafafa 100%);background-color:#fef7f7;border-radius:12px;border-left:4px solid #c92A2A;">
                              <p style="font-size:15px;line-height:1.6;margin:0;font-style:italic;color:#6a7180;">
