export const htmlRequestAcknowledgment = `<!DOCTYPE html>
         <html lang="en">
            <head>
               <meta charset="UTF-8">
               <meta name="viewport" content="width=device-width, initial-scale=1.0">
               <title>APAC Management System - Request Received - {{requestType}} Request</title>
               <!--[if mso]>
               <style>
                              ...
                              <td class="header-bg" style="background:linear-gradient(135deg, #c92A2A 0%, #d43f3f 50%, #e25757 100%);background-color:#c92A2A;padding:40px 30px;color:#ffffff;text-align:left;position:relative;overflow:hidden;">
                                 ...
                                 <div style="position:relative;z-index:3;">
                                    ...
                                    <p style="margin:0;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-size:15px;font-weight:600;color:#f8f9fa;letter-spacing:1.2px;">
                                       Request Received - {{requestType}} Request
                                    </p>
                                 </div>
                              </td>
                           </tr>
                           ...
                           <tr>
                              <td class="body-bg" style="padding:45px 35px;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;color:#2a2d37;text-align:left;background:linear-gradient(180deg, #ffffff 0%, #fdfdfd 100%);background-color:#ffffff;">
                                 ...
                                 <p style="font-size:16px;line-height:1.7;margin:0 0 30px 0;color:#4a4f5c;">
                                    We've successfully received your <strong style="color:#c92A2A;">{{requestType}}</strong> request. Your request has been submitted and is now under review.
                                 </p>
                                 ...
                                 <div style="margin:30px 0;padding:25px;background:linear-gradient(135deg, #f8f9fa 0%, #f0f2f5 100%);background-color:#f8f9fa;border-radius:12px;border-left:4px solid #c92A2A;">
                                    ...
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                       <tr>
                                          <td width="140" style="padding:5px 0;"><strong style="color:#5a6170;">HR Department:</strong></td>
                                          <td style="padding:5px 0;color:#2a2d37;">
                                             <a href="mailto:{{hrEmail}}" style="color:#2a2d37;text-decoration:none;">{{hrEmail}}</a>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td width="140" style="padding:5px 0;"><strong style="color:#5a6170;">Your Team Lead:</strong></td>
                                          <td style="padding:5px 0;color:#2a2d37;">
                                             <a href="mailto:{{teamLeadEmail}}" style="color:#2a2d37;text-decoration:none;">{{teamLeadFullName}}</a>
                                          </td>
                                       </tr>
                                    </table>
                                 </div>
                                 ...
                                 <div style="margin:35px 0 0 0;padding:25px;background:linear-gradient(135deg, #fef7f7 0%, #fafafa 100%);background-color:#fef7f7;border-radius:12px;border-left:4px solid #c92A2A;">
                                    <p style="font-size:15px;line-height:1.6;margin:0;font-style:italic;color:#6a7180;">
                                       ...
                                       <strong style="color:#2a2d37;font-size:16px;">We'll keep you updated on your request progress.</strong>
                                    </p>
                                 </div>
                              </td>
                           </tr>
<!-- Footer Section -->
         ...
         `;
export const htmlTLAddRequest = `<!DOCTYPE html>
         <html lang="en">
            <head>
               <meta charset="UTF-8">
               <meta name="viewport" content="width=device-width, initial-scale=1.0">
                        ...
                        <table role="presentation" cellpadding="0" cellpadding="0" border="0" width="600" style="background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 15px 50px rgba(201,42,42,0.15);border:1px solid rgba(201,42,42,0.1);">
                           ...
                           <tr>
                              <td class="header-bg" style="background:linear-gradient(135deg, #c92A2A 0%, #d43f3f 50%, #e25757 100%);background-color:#c92A2A;padding:40px 30px;color:#ffffff;text-align:left;position:relative;overflow:hidden;">
                                 ...
                                 <div style="position:relative;z-index:3;">
                                    ...
                                    <div style="height:3px;width:60px;background:linear-gradient(90deg, rgba(255,255,255,0.8) 0%, transparent 100%);background-color:rgba(255,255,255,0.8);margin:12px 0 8px 0;border-radius:2px;"></div>
                                    <p style="margin:0;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-size:15px;font-weight:600;color:#f8f9fa;letter-spacing:1.2px;">
                                       Review Required - {{applicantFullName}} - {{requestType}} Request
                                    </p>
                                 </div>
                              </td>
                           </tr>
                           ...
                           <tr>
                              ...
                              <div style="width:90px;height:90px;background:linear-gradient(135deg, rgba(201,42,42,0.08) 0%, rgba(226,87,87,0.12) 100%);background-color:rgba(201,42,42,0.08);border-radius:50%;line-height:90px;text-align:center;font-size:36px;color:#c92A2A;border:2px solid rgba(201,42,42,0.1);box-shadow:0 8px 25px rgba(201,42,42,0. 15);">
                                 ...
                                 <p style="font-size:16px;line-height:1.7;margin:0 0 30px 0;color:#4a4f5c;">
                                    As <strong style="color:#c92A2A;">{{teamLeadRole}}</strong>, your review is required for a <strong style="color:#c92A2A;">{{requestType}}</strong> request from {{applicantFullName}}.
                                 </p>
                                 <div style="margin:30px 0;padding:25px;background:linear-gradient(135deg, #f8f9fa 0%, #f0f2f5 100%);background-color:#f8f9fa;border-radius:12px;border-left:4px solid #c92A2A;">
                                    <p style="font-size:16px;font-weight:600;color:#2a2d37;margin:0 0 15px 0;display:flex;align-items:center;">
                                       📋 Request Details
...
<!-- Footer Section -->
         ...
         `;
export const htmlCooAddRequest = `<!DOCTYPE html>
         <html lang="en">
            <head>
               <meta charset="UTF-8">
               <meta name="viewport" content="width=device-width, initial-scale=1.0">
               <title>APAC Management System - Review Required - {{applicantFullName}} - {{requestType}} Request</title>
               <!--[if mso]>
               <style>
                  .header-bg { background-color: #c92A2A !important; }
                  .button-bg { background-color: #c92A2A !important; }
                        ...
                        <table role="presentation" cellpadding="0" cellpadding="0" border="0" width="600" style="background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 15px 50px rgba(201,42,42,0.15);border:1px solid rgba(201,42,42,0.1);">
                           ...
                           <tr>
                              <td class="body-bg" style="padding:45px 35px;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;color:#2a2d37;text-align:left;background:linear-gradient(180deg, #ffffff 0%, #fdfdfd 100%);background-color:#ffffff;">
                                 ...
                                 <p style="font-size:16px;line-height:1.7;margin:0 0 30px 0;color:#4a4f5c;">
                                    As <strong style="color:#c92A2A;">Chief Operating Officer</strong>, your review is required for a <strong style="color:#c92A2A;">{{requestType}}</strong> request from {{applicantFullName}}.
                                 </p>
                                 <!--  Request Details Card -->
                                 <div style="margin:30px 0;padding:25px;background:linear-gradient(135deg, #f8f9fa 0%, #f0f2f5 100%);background-color:#f8f9fa;border-radius:12px;border-left:4px solid #c92A2A;">
                                    <p style="font-size:16px;font-weight:600;color:#2a2d37;margin:0 0 15px 0;display:flex;align-items:center;">
