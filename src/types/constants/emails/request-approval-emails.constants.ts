export const htmlRequesterApproval = `<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>APAC Management System - Request Approved - {{applicantFullName}} - {{requestType}} Request</title>
      <!--[if mso]>
      <style>
               ...
               <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 15px 50px rgba(201,42,42,0.15);border:1px solid rgba(201,42,42,0.1);">
                  ...
                  <tr>
                     <td class="header-bg" style="background:linear-gradient(135deg, #c92A2A 0%, #d43f3f 50%, #e25757 100%);background-color:#c92A2A;padding:40px 30px;color:#ffffff;text-align:left;position:relative;overflow:hidden;">
                        <div style="position:absolute;top:0;left:0;width:100%;height:100%;background:url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" opacity="0.05">
                        ...
                        Request Approved - {{applicantFullName}} - {{requestType}} Request
                           </p>
                        </div>
                     </td>
                  </tr>
                  ...
                  <tr>
                     <td class="body-bg" style="padding:45px 35px;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;color:#2a2d37;text-align:left;background:linear-gradient(180deg, #ffffff 0%, #fdfdfd 100%);background-color:#ffffff;">
                        ...
                        <p style="font-size:16px;line-height:1.7;margin:0 0 30px 0;color:#4a4f5c;">
                           Your <strong style="color:#c92A2A;">{{requestType}}</strong> request has been <strong style="color:#c92A2A;">Approved</strong> by {{approverName}}.
                        </p>
                        ...
                        <div style="margin:30px 0;padding:25px;background:linear-gradient(135deg, #f8f9fa 0%, #f0f2f5 100%);background-color:#f8f9fa;border-radius:12px;border-left:4px solid #c92A2A;">
                           ...
                           <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                 <td width="140" style="padding:5px 0;"><strong style="color:#5a6170;">Approved By:</strong></td>
                                 <td style="padding:5px 0;color:#2a2d37;"><span style="background:#c92A2A;color:white;padding:2px 8px;border-radius:4px;font-size:12px;margin-left:8px;">{{approverName}}</span></td>
                              </tr>
                           </table>
                        </div>
...
`;
export const htmlTLApproval = `<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
   ...
   <body style="margin:0;padding:0;background:linear-gradient(135deg, #f7f9fc 0%, #f0f2f5 100%);background-color:#f0f2f5;">
      <table role="presentation" cellpadding="0" cellpadding="0" border="0" width="100%">
         <tr>
            <td align="center" style="padding:20px 30px;">
               <table role="presentation" cellpadding="0" cellpadding="0" border="0" width="600" style="background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 15px 50px rgba(44,90,160,0.15);border:1px solid rg(44,90,160,0.1);">
                  <!-- Header Section -->
                  <tr>
                     <td class="header-bg" style="background:linear-gradient(135deg, #c92A2A 0%, #d43f3f 50%, #e25757 100%);background-color:#c92A2A;padding:40px 30px;color:#ffffff;text-align:left;position:relative;overflow:hidden;">
                  ...
                  <tr>
                     <td class="body-bg" style="padding:45px 35px;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;color:#2a2d37;text-align:left;background:linear-gradient(180deg, #ffffff 0%, #fdfdfd 100%);background-color:#ffffff;">
                        ...
                        <p style="font-size:16px;line-height:1.7;margin:0 0 30px 0;color:#4a4f5c;">
                           This is to inform you that the <strong style="color:#c92A2A;">{{requestType}}</strong> request from your team member <strong>{{applicantFullName}}</strong> has been <strong style="color:#c92A2A;">Approved</strong> by {{hrFullName}}.
                        </p>
                        <!-- Request Details Card -->
                        <div style="margin:30px 0;padding:25px;background:linear-gradient(135deg, #f8f9fa 0%, #f0f2f5 100%);background-color:#f8f9fa;border-radius:12px;border-left:4px solid #c92A2A;">
                           <p style="font-size:16px;font-weight:600;color:#2a2d37;margin:0 0 15px 0;display:flex;align-items:center;">
...
`;
export const htmlAdminApproval = `<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
               ...
               <table role="presentation" cellpadding="0" cellpadding="0" border="0" width="600" style="background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 15px 50px rgba(201,42,42,0.15);border:1px solid rgba(201,42,42,0.1);">
                  ...
                  <tr>
                     ...
                     <div style="width:90px;height:90px;background:linear-gradient(135deg, rgba(201,42,42,0.08) 0%, rgba(226,87,87,0.12) 100%);background-color:rgba(201,42,42,0.08);border-radius:50%;line-height:90px;text-align:center;font-size:36px;color:#c92A2A;border:2px solid rgba(201,42,42,0.1);box-shadow:0 8px 25px rgba(201,42,42,0.15);">
                        ...
                        <p style="font-size:16px;line-height:1.7;margin:0 0 30px 0;color:#4a4f5c;">
                           This is to inform you that the <strong style="color:#c92A2A;">{{requestType}}</strong> request by {{applicantFullName}} has been formally <strong style="color:#c92A2A;">Approved</strong> by {{hrFullName}}.
                        </p>
                        <!-- Request Details Card -->
                        <div style="margin:30px 0;padding:25px;background:linear-gradient(135deg, #f8f9fa 0%, #f0f2f5 100%);background-color:#f8f9fa;border-radius:12px;border-left:4px solid #c92A2A;">
                           <p style="font-size:16px;font-weight:600;color:#2a2d37;margin:0 0 15px 0;display:flex;align-items:center;">
